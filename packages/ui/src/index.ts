...
// ── Icons ────────────────────────────────────────────────────────────────────
// Icon value re-exports were removed from this barrel to preserve tree-shaking
// in Turbopack/webpack: a flat `export { ... } from "./icons.js"` block forces
// every consumer of `@supernote/ui` to compile all 147 phosphor icon modules.
// Import icons directly from `@phosphor-icons/react` instead, e.g.:
//   import { House, MagnifyingGlass } from "@phosphor-icons/react";
// The mapping (e.g. IconHome → House) is documented in `./icons.ts`, which is
// preserved for any consumer that still imports from `@supernote/ui/icons`.
//
// Type re-exports remain — they have zero runtime cost.

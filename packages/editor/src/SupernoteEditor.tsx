...
export function SupernoteEditor(props: SupernoteEditorProps): React.JSX.Element {
  ...
  // Gmail embed : null → fallback statique du bloc.
  ...
  const handleWrapperClick = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      if (last && ((last.type as string) === "databaseView" || (last.type as string) === "googleSheet" || (last.type as string) === "gmailMessage")) {
        try {
          const inserted = editor.insertBlocks(
            [{ type: "paragraph" } as any],
            last as any,
  ...
  return (
    ...
    <GmailEmbedProvider api={gmailEmbedApi}>
    <div
      ref={wrapperRef}
